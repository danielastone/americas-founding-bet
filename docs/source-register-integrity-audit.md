...
| Numeric sequence gaps, AFB-S001 through AFB-S094 | 0 |
...
Those checks remain open under issue #1 and must be completed in bounded batches. The P1-priority metadata batch is documented in `docs/source-register-p1-metadata-audit.md`.
